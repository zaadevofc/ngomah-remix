...
const CardInfo = () => {
    return (
        <>
            <div className="w-full h-52 bg-green-600 bg-[url('/bg/line.svg')] -mt-3 -z-[1] flex justify-center items-center relative">
                    ...
                    <div className="flex flex-row drop-shadow-md bg-white rounded-3xl justify-between default-border px-5 py-2">
                        <div className="flex flex-row items-center gap-3">
                            ...
                            <div className="flex flex-col leading-tight text-sm">
                                ...
                                <h1 className="text-green-700 font-medium text-[13px]">Cek riwayat {'>'}</h1>
                            </div>
                        </div>
